  ...
  const fetchFoodItems = async () => {
    try {
      const response = await axios.get(
        "http://192.168.1.4:3000/api/food-items/list?canteenId=643bf46d34379c74054a99ee&mealType=breakfast"
      );
...
export default HelaBojunBreakfast;
